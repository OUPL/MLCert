...
Makefile.conf: 
	coq_makefile -R . MLCert -arg '-w none' bitnet.v cont.v extraction.v float32.v kernel.v learners.v linearclassifiers.v monads.v net.v noise.v samplers.v -o Makefile
