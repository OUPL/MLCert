...
Makefile.conf: 
	coq_makefile -R . MLCert -arg '-w none' cont.v axioms.v extraction_hs.v extraction_ocaml.v bitvectors.v float32.v learners.v oracleclassifiers.v linearclassifiers.v monads.v noise.v samplers.v -o Makefile
