...
# coq_makefile compile.v dyadic.v extrema.v listlemmas.v maplemmas.v net.v numerics.v orderedtypes.v strings.v vector.v 
#
...
.merlin:
	...
	@echo "B /home/gstewart/Repos/deepse" >> .merlin
	@echo "S /home/gstewart/Repos/deepse" >> .merlin
