...
main = defaultMain [
    env (setupEnv "../data/sonar75train.dat" "../data/sonar75test.dat") $ \ ~ (test, train) ->
    bgroup "kpdsonar75" [ bench "DescriptionKernelPerceptron" $ nfIO (kperceptrondeshelper n des epochs 15.0 train test) ]
    ]
